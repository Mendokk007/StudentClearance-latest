    ...
    public partial class HomeForm : Form
    {
        ...
        private void ApplyNotificationBadgeState()
        {
            ...
            else
            {
                ...
                btnViewNotifications.ForeColor = Color.White;
            }
        }
        ...
        private void SetupNotificationsPanel()
        {
            ...
            pnlNotifications.BackColor = Color.FromArgb(47, 49, 54);
            pnlNotifications.Size = new Size(300, 400);
            pnlNotifications.Location = new Point(this.Width - 320, 80);
            ...
            lblNotificationTitle.Font = new Font("Segoe UI", 12, FontStyle.Bold);
            lblNotificationTitle.ForeColor = Color.White;
            lblNotificationTitle.Location = new Point(10, 10);
            lblNotificationTitle.Size = new Size(200, 25);
            pnlNotifications.Controls.Add(lblNotificationTitle);

            btnCloseNotifications = new Button();
            btnCloseNotifications.Text = "X";
            btnCloseNotifications.BackColor = Color.FromArgb(217, 55, 55);
            btnCloseNotifications.ForeColor = Color.White;
            btnCloseNotifications.FlatStyle = FlatStyle.Flat;
            btnCloseNotifications.FlatAppearance.BorderSize = 0;
            btnCloseNotifications.Size = new Size(30, 25);
            btnCloseNotifications.Location = new Point(260, 10);
            ...
            lstNotifications.BackColor = Color.FromArgb(64, 68, 75);
            lstNotifications.ForeColor = Color.White;
            lstNotifications.BorderStyle = BorderStyle.None;
            lstNotifications.Location = new Point(10, 45);
            lstNotifications.Size = new Size(280, 310);
            ...
            btnMarkRead.BackColor = Color.FromArgb(240, 71, 71);
            btnMarkRead.ForeColor = Color.White;
            btnMarkRead.FlatStyle = FlatStyle.Flat;
            btnMarkRead.FlatAppearance.BorderSize = 0;
            btnMarkRead.Size = new Size(120, 30);
            btnMarkRead.Location = new Point(10, 362);
        ...
        private void SetupClearanceSystem()
        {
            ...
            lblClearanceTitle.Font = new Font("Segoe UI", 14F, FontStyle.Bold);
            lblClearanceTitle.ForeColor = Color.White;
            lblOverallStatus.Text = "Overall Progress: 0/6";
            lblOverallStatus.Font = new Font("Segoe UI", 9F);
            lblOverallStatus.ForeColor = Color.FromArgb(185, 187, 190);
            progressOverall.Style = ProgressBarStyle.Continuous;
            progressOverall.ForeColor = Color.FromArgb(240, 71, 71);
        }
                            ...
                            while (reader.Read())
                            {
                                ...
                                else
                                {
                                    ...
                                    if (controls.submitButton != null && reader["SubmittedAt"] != DBNull.Value)
                                    {
                                        ...
                                        controls.submitButton.BackColor = Color.FromArgb(255, 193, 7);
                                        controls.submitButton.Enabled = false;
                                        controls.statusLabel.Text = "Pending Review";
                                        controls.statusLabel.ForeColor = Color.FromArgb(255, 193, 7);
                                    }
                                }
                            }
                        }
        ...
        private void UpdateDepartmentStatus(string department, string status)
        {
            ...
            if (controls.submitButton != null)
            {
                ...
                else if (status == "Rejected")
                {
                    ...
                    controls.statusLabel.Text = "Rejected - Click to resubmit";
